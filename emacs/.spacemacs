  ...
  (setq-default
   ...
   '(javascript
     ...
     (shell :variables
            ...
            shell-default-position 'multi-term)
     spell-checking
     syntax-checking
     tabbar
     evil-snipe
